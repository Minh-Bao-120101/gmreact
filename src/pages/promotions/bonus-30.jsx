...
export default function Bonus30() {
  return (
    <>
              ...
              <article className="article" style="margin-top: 24px">
                <div className="article__content">
                  ...
                  <ol>
                    ...
                    <li>Deposit funds and the bonus will be credited automatically.</li>
                  </ol>
      
                  <p>
                    <strong>Note:</strong> This offer may be modified or withdrawn at any time without prior notice.
                  </p>
                </div>
