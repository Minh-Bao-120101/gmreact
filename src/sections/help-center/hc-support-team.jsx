    ...
    <section id="hc-support-team" className="at-section container fade-in">
      ...
      >
        <article className="at-card">
          ...
          >
            <a className="btn btn-primary" href="tel:+84124245">
              Call now
            </a>
          </div>
        </article>
        ...
        <article className="at-card">
          ...
          >
            ...
            <a className="btn btn-outline" href="/pages/help-center.html#ticket">
              How it works
            </a>
          </div>
        </article>
        ...
        <article className="at-card">
          ...
          >
            ...
            <a className="btn btn-outline" href="/pages/help-center.html#chat">
              Chat availability
            </a>
          </div>
        </article>
