...
export default function AccountTypesTabs() {
  return (
    <>
      <section id="account-types-tabs" className="at-section container fade-in" data-tabs-root="">
        <h2 className="section__title">Account Specifications by Instrument</h2>
        <p className="section__desc">
          Compare live trading conditions across ECN, Standard, and Cent accounts.
        </p>
      
        
        <div className="gm-tabs" role="tablist" aria-label="Account Types">
          <button className="gm-tab is-active" role="tab" aria-selected="true" data-tab="ecn">
            ECN Account
          </button>
          <button className="gm-tab" role="tab" aria-selected="false" data-tab="standard">
            Standard Account
          </button>
          <button className="gm-tab" role="tab" aria-selected="false" data-tab="cent">
            Cent Account
          </button>
        </div>
        ...
        <div className="gm-panels">
          ...
          <div className="gm-panel is-active" data-panel="ecn">
            ...
            <div className="btn-group" style="--btn-gap: 1rem; margin-top: 1rem">
              <button className="btn btn-outline" data-load-more="">View more</button>
              <a className="btn btn-primary" data-open-modal="register-modal">Open ECN</a>
            </div>
          </div>
          ...
          <div className="gm-panel" data-panel="standard">
            ...
            <div className="btn-group" style="--btn-gap: 1rem; margin-top: 1rem">
              <button className="btn btn-outline" data-load-more="">View more</button>
              <a className="btn btn-primary" data-open-modal="register-modal">Open Standard</a>
            </div>
          </div>
          ...
          <div className="gm-panel" data-panel="cent">
            ...
            <div className="btn-group" style="--btn-gap: 1rem; margin-top: 1rem">
              <button className="btn btn-outline" data-load-more="">View more</button>
              <a className="btn btn-primary" data-open-modal="register-modal">Open Cent</a>
            </div>
          </div>
        </div>
      </section>
