        ...
        <div className="at-grid-3" style="margin-top: var(--space-xl); text-align: left">
          ...
          <article className="at-card">
            ...
            <div className="btn-group" style="--btn-gap: 1rem; margin-top: 1rem">
              <a className="btn btn-primary" href="/assets/downloads/mt5-setup.exe">Download Windows</a>
              <a className="btn btn-outline" href="/pages/trading-platforms.html#desktop">Learn more</a>
            </div>
          </article>
          ...
          <article className="at-card">
            ...
            <div className="btn-group" style="--btn-gap: 1rem; margin-top: 1rem">
              ...
              <a className="btn btn-outline" href="/pages/trading-platforms.html#web">Learn more</a>
            </div>
          </article>
