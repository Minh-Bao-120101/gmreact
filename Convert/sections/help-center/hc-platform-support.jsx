        ...
        <div className="at-grid-3" style="margin-top: var(--space-xl); text-align: left">
          <article className="at-card">
            ...
            <div className="btn-group" style="--btn-gap: 1rem; margin-top: 1rem">
              <a className="btn btn-primary" href="/assets/downloads/mt5-setup.exe">Download MT5</a>
              <a className="btn btn-outline" href="/pages/help-center.html#mt-install">Read guide</a>
            </div>
          </article>
          ...
          <article className="at-card">
            ...
            <div className="btn-group" style="--btn-gap: 1rem; margin-top: 1rem">
              <a className="btn btn-outline" href="/pages/help-center.html#servers">Server list</a>
            </div>
          </article>
